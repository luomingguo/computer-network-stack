...
// Helper to serialize any object (without constructing a Serializer of the
// caller's own)
...
// Helper to parse any object (without constructing a Parser of the caller's
// own). Returns true if successful.
