  ...
  try {
...

    {
      ...
      ReassemblerTestHarness test{
          "overlapping unassembled section to fill hole", cap};
...

    {
      ...
      const size_t cap = {1000};
      ReassemblerTestHarness test{"overlapping multiple unassembled sections",
                                  cap};
...

    {
      // Credit: Chenhao Li
      const size_t cap = {1000};
      ReassemblerTestHarness test{"overlapping multiple unassembled sections 2",
                                  cap};
    ...
    {
      // Credit: Tanmay Garg
      ReassemblerTestHarness test{"overlapping multiple unassembled sections 3",
                                  30};
